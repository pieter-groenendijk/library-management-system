...
import static com.github.pieter_groenendijk.domain.shared.ServiceUtils.PICKUP_DAYS;
import static com.github.pieter_groenendijk.domain.shared.ServiceUtils.PICKUP_EXPIRY_DAYS;
...
public class ReservationService implements IReservationService {
    ...
    @Override
    public void handleUncollectedReservations(long accountId, LocalDate currentDate) throws Exception {
